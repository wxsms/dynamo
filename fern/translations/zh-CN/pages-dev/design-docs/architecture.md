...
有关流程级细节，请参阅 [Architecture Flow](../../../../../docs/design-docs/dynamo-flow.md)。
有关请求传输选项，请参阅 [Request Plane](../../../../../docs/design-docs/request-plane.md)。
...
Planner 支持基于吞吐量和基于负载的策略。请参阅 [Planner 设计](planner-design.md)。
...
请参阅 [Fault Tolerance](../../../../../docs/fault-tolerance/README.md)。
...
- [Architecture Flow](../../../../../docs/design-docs/dynamo-flow.md)
- [Router Design](../../../../../docs/design-docs/router-design.md)
- [Planner 设计](planner-design.md)
- [Discovery Plane](../../../../../docs/design-docs/discovery-plane.md)
- [Event Plane](../../../../../docs/design-docs/event-plane.md)
- [Request Plane](../../../../../docs/design-docs/request-plane.md)
- [Fault Tolerance](../../../../../docs/fault-tolerance/README.md)
