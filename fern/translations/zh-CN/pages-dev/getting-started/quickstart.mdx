...
有关容器版本和标签，请参阅 [Release Artifacts](../../../../../docs/reference/release-artifacts.md#container-images)。
...
<Info>
连接被拒绝？前端需要几秒钟才能启动 — 请重试。有关生产环境的存活和就绪探针，请参阅 [Health Checks](../../../../../docs/observability/health-checks.md)。
</Info>
