...
- **[SGLang Diffusion LMs (upstream)](https://github.com/sgl-project/sglang/blob/main/docs_new/docs/supported-models/diffusion_language_models.mdx)**: SGLang diffusion documentation
