...
- [Agent Simulation](agent-replay.mdx) — replay captured agent traces
- [ThunderAgent Program Scheduler](thunderagent-router.md) — program-level scheduling keyed by `session_id`
