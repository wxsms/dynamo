...
<CardGroup cols={4}>
  ...
  <Card title="Kubernetes" icon="regular cubes" href="kubernetes-deployment.mdx">
    Kubernetes-native production path.
  </Card>
  <Card title="Build from Source" icon="regular code-branch" href="building-from-source.md">
