...
- A [recipe or backend template](../getting-started/kubernetes-deployment.mdx#create-a-dgd) already
...
See the [Profiler Guide](../components/profiler/profiler-guide.md) for support, gate checks, picking
...
<CardGroup cols={3}>
  ...
  <Card title="DGDR Templates" icon="regular file-code" href="../templates/dgdr.mdx">
    Start from copyable requests for rapid, thorough, Planner, mocker, and override workflows.
  </Card>
  <Card title="Profiler" icon="regular magnifying-glass-chart" href="dgdr-profiler.md">
    Understand candidate evaluation, ranking, and generated profiling data.
  </Card>
  <Card title="Planner" icon="regular chart-line" href="dgdr-planner.mdx">
    Configure optional runtime autoscaling for the generated deployment.
  </Card>
  <Card title="DGDR Reference" icon="regular book" href="dgdr-reference.mdx">
    Review fields, defaults, lifecycle phases, status, and validation behavior.
  </Card>
  <Card title="Deploy with DGD" icon="regular pen-to-square" href="dgd-guide.md">
