...
- [Azure Lustre CSI Driver](cloud-providers/aks/azure-lustre-csi.mdx) — provision AMLFS and the striping recommendation for it
- [Storage for Model Caching on AKS](cloud-providers/aks/storage.md) — choosing a storage class per cache type
- [Snapshotting GPU Workers](snapshot.md) — checkpoint/restore and warm-start options for repeated restarts
