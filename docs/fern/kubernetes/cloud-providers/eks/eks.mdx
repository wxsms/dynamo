...
Follow the [EFS setup guide](efs.mdx) to create an EFS file system and make it available as shared storage for Dynamo workloads.
...
Cleanup EFS related resources, follow the [EFS setup guide](efs.mdx#cleanup) cleanup section
