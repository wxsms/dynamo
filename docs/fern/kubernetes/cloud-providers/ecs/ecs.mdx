...
<Steps toc={true}>
<Step title="EC2 Cluster Setup (for vLLM workloads)" id="1-ec2-cluster-setup-for-vllm-workloads">
...
<Step title="Fargate Cluster Setup (for ETCD/NATS services)" id="2-fargate-cluster-setup-for-etcdnats-services">
...
<Step title="ETCD/NATS Task Definitions Setup" id="3-etcdnats-task-definitions-setup">
...
<Step title="vLLM Task Definitions Setup" id="4-vllm-task-definitions-setup">
<Note>
...
<Step title="Task Deployment" id="5-task-deployment">
