...
<Steps toc={true}>
<Step title="Connect to your AKS cluster" id="step-1-connect-to-your-aks-cluster">
```bash
az login
...
<Step title="Install the CSI driver" id="step-2-install-the-csi-driver">
...
<Step title="Configure storage" id="step-3-configure-storage">
