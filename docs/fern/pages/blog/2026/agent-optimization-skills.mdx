...
To get started, just clone [Dynamo](https://github.com/ai-dynamo/dynamo), point your coding agent at the repo, and tell it to optimize your deployment. The [Agent Skills docs page](/dynamo/dev/reference/agent-skills) has the full skill inventory plus practical notes on GPU budgets and unattended runs. We'll be adding new skills all of the time, so agents will get smarter as Dynamo evolves.
