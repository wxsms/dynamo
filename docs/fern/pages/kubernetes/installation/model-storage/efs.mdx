...
- EKS cluster created following the [EKS guide](../managed-kubernetes/eks/eks-setup.mdx)
...
<Steps toc={true}>
<Step title="Retrieve VPC and Subnet Information" id="retrieve-vpc-and-subnet-information">
...
<Step title="Create a Security Group for EFS" id="create-a-security-group-for-efs">
...
<Step title="Create the EFS File System" id="create-the-efs-file-system">
```bash
...
<Step title="Create Mount Targets" id="create-mount-targets">
...
<Step title="Create Kubernetes StorageClass" id="create-kubernetes-storageclass">
...
<Step title="Create a PersistentVolumeClaim" id="create-a-persistentvolumeclaim">
