...
For example, refer to the [`release/1.5.0` disaggregated manifest](https://github.com/ai-dynamo/dynamo/blob/release/1.5.0/examples/deployments/GKE/vllm/disagg.yaml):
