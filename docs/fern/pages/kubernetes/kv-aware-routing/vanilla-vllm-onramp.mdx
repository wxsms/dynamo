...
[Install Gateway API Routing](../installation/gateway-api-routing.mdx) for the shared agentgateway and Istio
prerequisites.
...
Use [Route Requests with Gateway API](gateway-api.mdx) when you want the supported
