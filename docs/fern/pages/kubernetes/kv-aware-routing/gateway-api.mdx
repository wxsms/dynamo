...
For direct-to-Frontend routing, use [KV-Aware Routing with the Dynamo Frontend](dynamo-frontend.md).
...
- Gateway API, GAIE, and a compatible Gateway implementation installed. See
  [Install Gateway API Routing](../installation/gateway-api-routing.mdx).
