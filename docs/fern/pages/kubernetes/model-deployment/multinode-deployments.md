...
- [Topology Aware Scheduling](../../developer-guide/knowledge-base/kubernetes/multinode/topology-aware-scheduling.md) — pack pods within a rack, block, or other topology domain for lower latency
