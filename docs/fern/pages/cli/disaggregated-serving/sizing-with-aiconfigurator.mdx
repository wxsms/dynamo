...
endpoint. Use [Mocker Live Simulation](../operations/simulation-with-dynosim/mocker-live-simulation.mdx) for a live GPU-free deployment,
...
[Kubernetes multinode deployment](../../kubernetes/model-deployment/multinode-deployments.md) instead of treating the GPU budget as one flat local device list.
