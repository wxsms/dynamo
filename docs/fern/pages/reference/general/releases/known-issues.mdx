...
The v1.4.0 known issues come from the GitHub release notes and land here when the notes publish. Until then, the v1.3.1 entries below remain the latest recorded issues.
