...
| `strict_priority` | Router pending-queue tier. Higher values always precede lower values before the configured queue policy is applied; see [Priority Scheduling](priority-scheduling.md) for due-time ordering within a tier. |
