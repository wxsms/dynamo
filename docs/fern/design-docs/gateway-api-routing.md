...
For the task-oriented setup, see [Route Requests with Gateway API](../kubernetes/inference-gateway.mdx).
...
[Gateway API Routing Reference](../components/router/gateway-api-reference.mdx).
