...
endpoint. Use [Mocker Live Simulation](../dynosim/mocker-local.mdx) for a live GPU-free deployment,
[DynoSim Replay](../dynosim/runs.mdx) for request-level offline simulation, and
