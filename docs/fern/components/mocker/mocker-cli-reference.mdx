...
[Simulate a Kubernetes Deployment](../../dynosim/mocker.mdx) or
[Simulate a Local Deployment](../../dynosim/mocker-local.mdx); for the engine internals these flags
configure, see [Mocker Engine Architecture](../../design-docs/mocker-architecture.md).

The same engine settings apply to [DynoSim Runs](../../dynosim/runs.mdx): `python -m dynamo.replay`
...
For the timing-model design, see [Mocker Engine Architecture](../../design-docs/mocker-architecture.md#performance-model).
...
<CardGroup cols={2}>
  <Card title="Simulate a Kubernetes Deployment" icon="server" href="../../dynosim/mocker.mdx">
    Deploy and run the Mocker worker on Kubernetes.
  </Card>
  <Card title="Simulate a Local Deployment" icon="terminal" href="../../dynosim/mocker-local.mdx">
    Run a frontend and Mocker worker from the command line.
  </Card>
  <Card title="Run a DynoSim Simulation" icon="play" href="../../dynosim/runs.mdx">
