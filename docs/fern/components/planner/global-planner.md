...
See [DGDR Templates](../../templates/dgdr.mdx) and [Profiler Guide](../profiler/profiler-guide.md) for DGDR details.
...
- [DGDR Templates](../../templates/dgdr.mdx) — DGDR examples for generating per-pool configs
