...
For the routing cost model and worker-selection behavior, see [Routing Concepts](router-concepts.md). For shared tuning guidance, see [Configuration and Tuning](router-configuration.md).
...
- [Router Guide](router-guide.md)
- [Configuration and Tuning](router-configuration.md)
- [Disaggregated Serving](router-disaggregated-serving.md)
- [Router Design](../../design-docs/router-design.md)
- [Frontend Router](../frontend/README.md)
