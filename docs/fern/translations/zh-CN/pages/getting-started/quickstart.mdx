...
<CardGroup cols={4}>
  ...
  <Card title="本地安装" icon="regular laptop-code" href="local-installation.mdx">
    完整演练 — PyPI、配置。
  </Card>
  <Card title="Kubernetes" icon="regular cubes" href="../../../../getting-started/kubernetes-deployment.mdx">
    生产级多节点集群。
  </Card>
  <Card title="从源码构建" icon="regular code-branch" href="building-from-source.md">
    面向基于 `main` 的贡献者。
  </Card>
</CardGroup>
...
有关容器版本和标签，请参阅 [Release Artifacts](../../../../reference/release-artifacts.mdx)。
...
<CardGroup cols={2}>
  <Card title="面向 Agentic Inference 的全栈优化" icon="regular microchip" href="../../../../digest/agentic-inference/agentic-inference.mdx">
    Dynamo 如何在三层上优化 agentic 工作负载：前端 API、路由器和 KV cache 管理。
  </Card>
  <Card title="Flash Indexer：跨星系 KV 路由" icon="regular bolt" href="../../../../digest/flash-indexer/flash-indexer.mdx">
...
<CardGroup cols={2}>
  <Card title="架构" icon="regular sitemap" href="../design-docs/architecture.md">
    前端、路由器和 worker 如何协同工作。
  </Card>
  <Card title="前端指南" icon="regular bolt" href="../../../../components/frontend/README.md">
    Worker 发现、多模型路由、OpenAI 兼容性。
  </Card>
  <Card title="KV Cache 感知路由" icon="regular route" href="../../../../components/router/router-concepts.md#kv-cache-routing">
    路由器如何为了前缀复用而放置请求。
  </Card>
