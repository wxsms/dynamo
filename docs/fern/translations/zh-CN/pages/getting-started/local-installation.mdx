...
对于生产环境的多节点集群，请参阅 [Kubernetes 部署指南](../../../../kubernetes/quickstart.mdx)。如需为开发从源码构建，请参阅[从源码构建](building-from-source.md)。
...
如需查看可用版本，请参阅[发布产物](../../../../reference/release-artifacts.mdx)；
...
请参阅 [Kubernetes 中的模型缓存](../../../../kubernetes/model-caching.mdx#option-2-modelexpress-p2p-distribution)
    了解正确配置。
...
- [Kubernetes 部署](../../../../kubernetes/quickstart.mdx) -- 生产环境多节点部署
