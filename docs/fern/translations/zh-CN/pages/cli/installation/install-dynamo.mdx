...
本指南使用 `--discovery-backend file`。如需设置 etcd，请参阅[服务发现](../../../../../pages/developer-guide/knowledge-base/concepts/system-architecture/architecture.md#discovery-plane)。
...
请参阅 [Kubernetes 模型存储](../../../../../pages/kubernetes/installation/model-storage/overview.md)
    了解正确配置。
...
- [分离式服务](../../../../../pages/kubernetes/disaggregated-serving/overview.md) -- 独立扩展 prefill 和 decode
