...
- The aggregated embedding cache uses vLLM's native `ec_both` ECConnector role, supported in vLLM 0.17+ with no patches — see [multimodal vLLM docs](../features/multimodal/multimodal-vllm.md#embedding-cache).
