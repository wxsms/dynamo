...
| Goal | Start Here |
| --- | --- |
| Make your first code change | [Getting Started](contributing/getting-started.mdx) |
| Understand when to open an issue and how to submit a pull request | [Contribution Flow](contributing/contribution-flow.mdx) |
| Prepare code, tests, and commit messages | [Code Quality](contributing/code-quality.md) |
| Sign commits or fix a DCO check | [DCO and Licensing](contributing/dco-and-licensing.md) |
| Improve the documentation | [Documentation Style Guide](documentation-style-guide.md) |
| Build or preview the documentation site | [Building and Publishing](README.md) |
...
- [Getting Started](contributing/getting-started.mdx) is a tutorial for setting up a fork, preparing
  a development environment, and creating a signed first commit.
- [Contribution Flow](contributing/contribution-flow.mdx) explains issue-first changes, pull request
  submission, continuous integration (CI), and review.
- [Code Quality](contributing/code-quality.md) collects code style, testing, pre-commit, and commit
  message conventions.
- [DCO and Licensing](contributing/dco-and-licensing.md) explains sign-off requirements and how to
