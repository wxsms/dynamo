...
<ParamField path="--event-plane" type="string" default="zmq">
  ...
  explicitly to use NATS Core. See [Event Plane](../design-docs/event-plane.md) for design details.
