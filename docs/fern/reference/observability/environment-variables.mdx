...
[Observe a Local Deployment](../../observability/local-observability.mdx) and
...
See [Forward Pass Metrics Trace Reference](forward-pass-metrics-tracing.mdx) for topology support and file semantics.
...
See [Request Trace Reference](request-tracing.mdx) for compatibility aliases, sink behavior, and record semantics.
