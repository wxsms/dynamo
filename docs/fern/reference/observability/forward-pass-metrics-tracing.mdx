...
- [Observe a Local Deployment](../../observability/local-observability.mdx#capture-forward-pass-metrics)
- [Observability Architecture](../../design-docs/observability.md#forward-pass-metrics-persistence)
- [SGLang Observability](../../backends/sglang/sglang-observability.md#forward-pass-metrics-fpm)
