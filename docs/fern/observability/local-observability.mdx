...
behavior, see [Forward Pass Metrics Trace Reference](../reference/observability/forward-pass-metrics-tracing.mdx).
For the publication and persistence flow, see
[Observability Architecture](../design-docs/observability.md#forward-pass-metrics-persistence).
...
No Mooncake conversion is required. DynoSim derives and validates the trace block size. It preserves
...
[Observability Architecture](../design-docs/observability.md#active-worker-health-checks).
